...
export class SettingsAccountComponent implements OnInit, OnDestroy {
   ...
   uploadAvatar(fileList: FileList): void {
      ...
      if (file.size > 3145728) {
         this._snackbar.open(`Rasm hajmi 3 MB dan oshmasligi kerak`, 'OK', {
            duration: 10000
         });
         return;
      }
      ...
      this._settingsService.uploadAvatar(formData)
         .subscribe(() => {
            this._authService.getUser().subscribe();
            this._snackbar.open(`Profil rasmi muvaffaqiyatli o'zgartirildi`, 'OK', {
               duration: 5000
            });
         });
   }
